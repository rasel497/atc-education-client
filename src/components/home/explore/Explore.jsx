            ...
            <div className='mt-32 w-4/5'>
                <div className="card bg-base-100 grid lg:grid-cols-2 sm:grid-cols-1 shadow-2xl">
                    ...
                    <div className="card-body w-4/3">
                        <h2 className="text-2xl font-extrabold">ATC Education Online Professional Training Platform5</h2>
                        <p>Lorem ipsum dolor sit Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias, minus doloribus tempore minima id aperiam esse voluptate delectus harum culpa.</p>
